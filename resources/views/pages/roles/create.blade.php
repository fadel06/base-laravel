...
@section('content')
    <x-common.page-breadcrumb pageTitle="Tambah Peran" />

    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-800">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Form Role Baru</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">Isi informasi role dan pilih permissions</p>
        </div>
