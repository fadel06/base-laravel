...
@section('content')
    <x-common.page-breadcrumb pageTitle="Edit Peran" />

    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-800">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Peran</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">Update informasi peran dan hak akses</p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select name="guard_name" id="guard_name" required
                        ...
                        <option value="api" {{ old('guard_name', $role->guard_name) == 'api' ? 'selected' : '' }}>api
                        </option>
                    </select>
                    @error('guard_name')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        ...
                        <div class="rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <div
                                ...
                                <label class="flex cursor-pointer items-center gap-2">
                                    ...
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Pilih Semua
                                        Hak Akses</span>
                                </label>
                            </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="space-y-6">
                                    @foreach ($groupedPermissions as $group => $groupPermissions)
                                        <div
                                            class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/30">
                                            <!-- Group Header -->
                                            <div
                                                class="mb-3 flex items-center gap-2 border-b border-gray-200 pb-2 dark:border-gray-700">
                                                ...
                                                <span class="ml-auto text-xs text-gray-500 dark:text-gray-400">
                                                    {{ $groupPermissions->count() }} permission(s)
                                                </span>
                                            </div>
                                            ...
                                            <div class="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                                                @foreach ($groupPermissions->sortBy('name') as $permission)
                                                    <label
                                                        class="flex cursor-pointer items-center gap-2 rounded-md p-2 transition-colors hover:bg-white dark:hover:bg-gray-700/50">
                                                        <input type="checkbox" name="permissions[]"
                                                            value="{{ $permission->id }}"
                                                            {{ in_array($permission->id, $rolePermissions) ? 'checked' : '' }}
                                                            class="permission-checkbox h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800">
