    ...
    <div class="relative z-1 min-h-screen bg-white dark:bg-gray-900">
        <div class="relative flex min-h-screen w-full flex-col lg:flex-row dark:bg-gray-900">
                ...
                <div class="w-full max-w-md">
                    ...
                    <div class="mb-8 text-center">
                        <div class="mb-4 flex items-center justify-center gap-4">
                            <img src="{{ asset('images/logo-banten.png') }}" alt="Logo Banten"
                        ...
                        <p class="mt-2 text-sm font-medium text-gray-500 dark:text-gray-400">
                            Aplikasi Agenda Diskominfo Provinsi Banten
                        </p>
                    </div>
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <div x-data="{ showPassword: false }" class="relative">
                                    ...
                                    <input :type="showPassword ? 'text' : 'password'" name="login_password"
                                        autocomplete="off" readonly onfocus="this.removeAttribute('readonly')"
                                        placeholder="Masukkan password"
                                        class="shadow-theme-xs focus:border-brand-500 focus:ring-brand-500/10 h-11 w-full rounded-lg border border-gray-300 bg-transparent pl-10 pr-11 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('login_password') border-red-500 @enderror" />
                                    <span @click="showPassword = !showPassword"
                                        class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                            ...
                            <div>
                                ...
                                <div class="flex gap-3">
                                    {{-- Captcha Display --}}
                                    <div
                                        class="flex h-11 flex-1 items-center justify-center rounded-lg border border-gray-300 bg-gray-50 px-4 dark:border-gray-700 dark:bg-gray-800">
                                        <span
                                            class="captcha-display font-mono text-lg font-bold tracking-[0.35em] text-gray-700 dark:text-gray-300 select-none"
                                    ...
                                    <button type="button" id="refreshCaptchaBtn"
                                        class="flex h-11 w-11 items-center justify-center rounded-lg border border-gray-300 bg-white text-gray-500 transition-colors hover:bg-gray-50 hover:text-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700"
                            ...
                            <div>
                                <button type="submit"
                                    class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 flex w-full items-center justify-center gap-2 rounded-lg px-4 py-3 text-sm font-medium text-white transition focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2">
                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="mt-8 text-center text-xs text-gray-400 dark:text-gray-600">
                        &copy; {{ date('Y') }} Dinas Komunikasi Informatika Statistik dan Persandian Provinsi Banten
                    </p>
                ...
                <div class="relative z-10 flex items-center justify-center">
                    ...
                    <div class="flex max-w-md flex-col items-center px-8">
                        ...
                        <h2 class="mb-3 text-center text-2xl font-bold text-white">
                            Aplikasi Agenda Diskominfo
                        </h2>
                        <p class="text-center text-sm text-brand-100">
                        ...
                        <div class="mt-8 grid w-full grid-cols-1 gap-3">
                            <div class="flex items-center gap-3 rounded-xl bg-white/10 px-4 py-3 backdrop-blur-sm">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-white">Manajemen Agenda</p>
                                    <p class="text-xs text-brand-100">Kelola jadwal & kegiatan dinas</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="fixed right-6 bottom-6 z-50">
                <button
                    class="bg-brand-500 hover:bg-brand-600 inline-flex size-14 items-center justify-center rounded-full text-white transition-colors shadow-theme-lg"
