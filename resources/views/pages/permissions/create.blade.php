...
@section('content')
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-800">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Form Hak Akses Baru</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">Isi informasi hak akses</p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                        placeholder="Contoh: create-user, edit-post, delete-comment"
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        Gunakan format: action-resource (contoh: create-user, view-report)
                    </p>
                </div>
