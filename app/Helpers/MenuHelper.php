...
class MenuHelper
{
    public static function canAccess($path)
    {
        ...
        $permissionMap = [
            ...
            '/opds' => 'view-opds',
            // tambahkan permission lain di sini jika diperlukan
            // '/users' => 'view-users',
        ];
        ...
        if (!$permission) {
            return true; // Jika tidak ada permission yang dipetakan, izinkan akses
        }
    ...
    public static function isActive($basePath)
    {
        ...
        // Normalisasi: pastikan basePath diakhiri slash
